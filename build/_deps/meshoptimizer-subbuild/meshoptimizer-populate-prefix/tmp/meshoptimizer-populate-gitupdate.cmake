...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v1.1"
  WORKING_DIRECTORY "E:/dev/dx12RE/Sludge/build/_deps/meshoptimizer-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/dev/dx12RE/Sludge/build/_deps/meshoptimizer-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/dev/dx12RE/Sludge/build/_deps/meshoptimizer-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
